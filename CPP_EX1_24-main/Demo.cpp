...
int main()
{
    ...
    cout << Algorithms::isContainsCycle(g) << endl;    // Should print: "1" "The cycle is: 0->1->2->0".
    ...
    cout << Algorithms::isContainsCycle(g) << endl;    // Should print: "1" (true). //0 1 2 0 
...
// 5x5 matrix that reprsents a connected weighted graph.
    vector<vector<int>> graph32 = {
        ...
        {0, 0, 4, 0, 5},
        {0, 0, 0, 5, 0}};
    g.loadGraph(graph32); // Load the graph to the object.
